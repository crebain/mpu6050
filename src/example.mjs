//import { MPU6050, AccelFsRange, GyroFsRange, ClockDiv, ClockSource, Data3D, Quaternion, Vector3, Utils } from "@ros2jsguy/mpu6050-motion-data";
import pkg from '@ros2jsguy/mpu6050-motion-data';
const { MPU6050, AccelFsRange, GyroFsRange, ClockDiv, ClockSource, Data3D, Quaternion, Vector3, Utils } = pkg;
